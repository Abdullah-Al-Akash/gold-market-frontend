...
const Routing = () => {
  return (
    <div className="my-10">
      <Link to="/buy" className="btn btn-warning mt-4">
        <svg
      ...
      <Link to="/sell" className="btn btn-warning mt-4 ms-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
      ...
      <Link to="/transaction" className="btn btn-warning mt-4 md:ms-2 ms-0">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
