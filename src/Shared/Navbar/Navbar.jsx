...
const Navbar = () => {
    const navItems = <>
        ...
        <li className="brand-color">
            <Link to="/" className="font-semibold text-lg nav-link"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
